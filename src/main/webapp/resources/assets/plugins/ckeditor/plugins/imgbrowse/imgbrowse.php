...
class imgbrowse {
  ...
  protected $root = '/bppatilcollege.com/images';
  protected $imgext =  array('jpg','png');    // allowed image extensions
  ...
  public function getMenuImgs() {
    ...
    foreach($obdr as $fileobj) {
      ...
      if( in_array($fileobj->getExtension(), $this->imgext)) $re['imgs'] .= '<span><img src="bppatilcollege.com/images/333s.jpg" alt="'. $name .'" height="50" />'. $name .'</span>';
